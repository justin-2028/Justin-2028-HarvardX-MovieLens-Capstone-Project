...
edx %>%
  ggplot(aes(rating)) +
  geom_histogram(binwidth = 0.25, color = "blue3") +
...
count(movieId) %>%
ggplot(aes(n)) +
geom_histogram(bins = 30, color = "blue3") +
scale_x_log10() +
...
movie_avgs %>% qplot(b_m, geom ="histogram", bins = 10, data = ., color = I("blue3"),
...
user_effects%>% qplot(b_u, geom ="histogram", bins = 30, data = ., color = I("blue3"))
```
